...
public class ConversationController {
    ...
    public ResponseEntity<ApiResponse<ConversationListResponse>> updateConversation(
            ...
            @Valid @RequestBody com.example.chatbot.conversation.dto.ConversationUpdateRequest request) {
        ConversationListResponse response = conversationService.updateConversationTitle(id, request.getTitle());
        return ResponseEntity.ok(ApiResponse.ok(response));
    }
}
